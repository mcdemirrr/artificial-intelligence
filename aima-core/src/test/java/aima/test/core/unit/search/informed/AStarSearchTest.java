...
public class AStarSearchTest {
	...
	public void testAStarSearch() {
		...
		try {
			...
			// EightPuzzleBoard extreme = new EightPuzzleBoard(new int[]
			// {0,8,7,6,5,4,3,2,1});
			EightPuzzleBoard board = new EightPuzzleBoard(new int[] { 8, 1, 8,
					0, 4, 8, 2, 3, 8 });
			...
			Assert.assertEquals(17, agent.getActions().size());
			Assert.assertEquals("359", // "926" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("nodesExpanded"));
			Assert.assertEquals("212", // "534" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("queueSize"));
			Assert.assertEquals("213", // "535" GraphSearchReduced Frontier
	...
	public void testgetNumberOfMisplacedTiles() {
		...
		try {
			...
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			Assert.assertEquals(17, agent.getActions().size());
			Assert.assertEquals("1858", // "926" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("nodesExpanded"));
			Assert.assertEquals("1014", // "534" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("queueSize"));
			Assert.assertEquals("1015", // "535" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("maxQueueSize"));
		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Exception thrown");
	...
	public void testTreeSearchM() {
		...
		try {
			...
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			Assert.assertEquals(17, agent.getActions().size());
			Assert.assertEquals("12302", // "926" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("nodesExpanded"));
			Assert.assertEquals("20739", // "534" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("queueSize"));
			Assert.assertEquals("20740", // "535" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("maxQueueSize"));
		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Exception thrown");
	...
	@Test
	public void testgetTestTreeMis() {
		// added to narrow down bug report filed by L.N.Sudarshan of
		// Thoughtworks and Xin Lu of UCI
		try {
			// EightPuzzleBoard extreme = new EightPuzzleBoard(new int[]
			...
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			Assert.assertEquals(17, agent.getActions().size());
			Assert.assertEquals("1182432", // "926" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("nodesExpanded"));
			Assert.assertEquals("2167781", // "534" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("queueSize"));
			Assert.assertEquals("2167782", // "535" GraphSearchReduced Frontier
					agent.getInstrumentation().getProperty("maxQueueSize"));
		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Exception thrown");
