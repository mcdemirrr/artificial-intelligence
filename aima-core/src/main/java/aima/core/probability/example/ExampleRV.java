...
public class ExampleRV {
	...
	public static final RandVar UMBREALLA_t_RV = new RandVar("Umbrella_t",
			new BooleanDomain());
	public static final RandVar COUGH_RV = new RandVar("Cough",
			new BooleanDomain());
	public static final RandVar FEVER_RV = new RandVar("Fever",
			new BooleanDomain());
	public static final RandVar VÝTAMÝN_D_LEVEL_RV = new RandVar("Vitamin_D_level",
			new BooleanDomain());
	public static final RandVar INFECTED_RV = new RandVar("Ýnfected",
			new BooleanDomain());
}
